        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-6">
                <ul class="flex space-x-6 items-center">
                    ...
                    <li><a href="{{ url('/shoplisting') }}" class="text-gray-700 dark:text-gray-200 hover:text-green-600 dark:hover:text-green-400 transition-colors font-semibold">Shop</a></li>
                    <li><a href="{{ route('cart.index') }}" class="text-gray-700 dark:text-gray-200 hover:text-green-600 dark:hover:text-green-400 transition-colors">Cart</a></li>
