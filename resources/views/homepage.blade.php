    ...
    <div class="bg-white dark:bg-[#272e2d] rounded-2xl shadow-xl overflow-hidden">
        <div class="grid md:grid-cols-2 gap-8 items-center p-12">
            <div class="space-y-6">
                ...
                <p class="text-xl text-gray-600 dark:text-gray-300">Welcome to YouZoo, a shop for all your pet needs, where we try to keep our prices affordable, quality high, and  our support even higher. <br>Please look around and shop with us!</p>
