    ...
    <div class="container mx-auto px-6 py-4">
        ...
        <div id="mobile-menu" class="hidden md:hidden mt-4 pb-4 transition-all duration-300 ease-in-out">
            <ul class="flex flex-col space-y-4">
                ...
                <li>
                    <a href="{{ route('cart.index') }}" 
                       class="{{ request()->routeIs('cart.index') ? 'text-green-800 dark:text-green-300 font-bold' : 'text-gray-700 dark:text-gray-200 font-medium' }} hover:text-green-600 dark:hover:text-green-400 transition-colors block">
                        Cart
                    </a>
                </li>
            </ul>
