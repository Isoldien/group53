...
<footer class="bg-[#253b32] dark:bg-[#253b32] text-white mt-16 transition-colors duration-300">
    <div class="container mx-auto px-6 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                <!-- @TODO Newsletter -->
                <h4 class="text-lg font-semibold mb-4 text-white">Our Newsletter</h4>
                <div class="flex flex-wrap gap-2">
                    <input type="email" id="emailInput" placeholder="Enter your email..." class="flex-1 px-4 py-2 rounded-lg bg-[#142624] border border-[#272e2d] text-white focus:outline-none focus:border-green-400 placeholder-gray-500 min-w-[200px]">
                    <button type="button" class="px-6 py-2 bg-green-500 hover:bg-green-600 text-[#142624] rounded-lg font-bold transition-colors whitespace-nowrap">Subscribe</button>
                </div>
            </div>
        </div>
